...
Politique de confidentialité pour les différentes versions de l'application "**Python Blackjack**".


## **Collecte de données**

Notre application "**Python Blackjack**" ne collecte ni ne transmet aucune donnée vers des serveurs distants ou sur Internet. 
